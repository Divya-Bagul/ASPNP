...
Route::view('productadd','addproducts');
Route::view('user','user');
Route::view('contact','contact');
Route::view('about','about');
Route::view('showcategory','subcategory/showcategory');





Route::post("contactform",[products::class,'contact']);



Route::get("userform",[order::class,'get_product']);
...
Route::post("addcategory",[products::class,'set_category']);
Route::get("subcategory",[products::class,'subcategory']);
Route::post("addsubcategory",[products::class,'set_subcategory']);
Route::post("addsubcategorylevel1",[products::class,'set_subcategorylavel1']);


Route::get("productData/{product_id}",[products::class,'ProductShow']);
Route::get("homeForm",[products::class,'homeForm']);
...
Route::get("addcategory",[products::class,'get_category']);
...
Route::get("deletecat/{id}",[products::class,'deletecat']);
Route::get("deletesubcat/{id}",[products::class,'deletesubcat']);





Route::get("product",[products::class,'category']);
Route::get("subcat",[products::class,'subcat']);
Route::get("subcatlevel1",[products::class,'subcatlevel1']);

Route::get("cat/{id}",[products::class,'getcat']);
Route::get("product_subcat/{id}",[products::class,'getsubcat']);
Route::get("product_subcatlevel1/{id}",[products::class,'getsubcatlevel1']);
